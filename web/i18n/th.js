...
export default {
  ...
  "limits.nonRecursive":
    "การสแกนไดเรกทอรีเป็นแบบชั้นเดียวโดยค่าเริ่มต้น ใส่ --recursive และใส่ --locale-from dir เพิ่มสำหรับผัง en/common.json เพื่อเข้าไปในไดเรกทอรีย่อย",

  "footer.license": "สัญญาอนุญาต MIT - ใช้ แก้ไข และเผยแพร่ได้อย่างอิสระ ทั้งเชิงพาณิชย์และไม่ใช่เชิงพาณิชย์",
};
