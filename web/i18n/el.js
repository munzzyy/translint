...
export default {
  ...
  "limits.nonRecursive":
    "Η σάρωση καταλόγου είναι επίπεδη από προεπιλογή. Δώστε --recursive, και --locale-from dir για τη διάταξη en/common.json, για να μπει σε υποκαταλόγους.",

  "footer.license": "Άδεια MIT - ελεύθερη για χρήση, τροποποίηση και διανομή, εμπορική ή μη.",
};
