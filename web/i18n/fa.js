...
export default {
  ...
  "limits.nonRecursive":
    "پویش پوشه به‌طور پیش‌فرض تخت است. برای رفتن به زیرپوشه‌ها --recursive را بدهید، و برای چیدمان en/common.json همراه با --locale-from dir.",

  "footer.license": "پروانه MIT - آزاد برای استفاده، تغییر و انتشار، تجاری یا غیرتجاری.",
};
