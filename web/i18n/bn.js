...
export default {
  ...
  "limits.nonRecursive":
    "ডিরেক্টরি স্ক্যান ডিফল্টে সমতল। সাবডিরেক্টরিতে ঢুকতে --recursive দিন, আর en/common.json বিন্যাসের জন্য সঙ্গে --locale-from dir দিন।",

  "footer.license": "MIT লাইসেন্স - ব্যবহার, পরিবর্তন ও বিতরণে মুক্ত, বাণিজ্যিক হোক বা না হোক।",
};
