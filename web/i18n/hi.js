...
export default {
  ...
  "limits.nonRecursive":
    "डायरेक्टरी स्कैन डिफ़ॉल्ट रूप से सपाट है। सबडायरेक्टरी में जाने के लिए --recursive दें, और en/common.json लेआउट के लिए साथ में --locale-from dir दें।",

  "footer.license": "MIT लाइसेंस - उपयोग, बदलाव और वितरण के लिए मुक्त, व्यावसायिक हो या न हो।",
};
